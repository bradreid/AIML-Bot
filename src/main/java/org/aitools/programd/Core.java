...
public class Core
{
    ...
    protected void start()
    {
        ...
        this.parser = XMLKit.getSAXParser(this.getClass().getClassLoader().getResource(AIML_SCHEMA_LOCATION), "AIML");
        ...
        try
        {
            this.pluginConfig = XMLKit.getDocumentBuilder(this.getClass().getClassLoader().getResource(PLUGINS_SCHEMA_LOCATION),
